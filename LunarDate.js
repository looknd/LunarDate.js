...
//农历节日
        ...
        function InitUi() {
            ...
            $("<span>").text("年").appendTo($thead_tr_td);
            ...
            for (var i = 0; i < 6; i++) {
                ...
                for (var j = 0; j < 7; j++) {
                    ...
                    $("<span>").css({'font-weight': 'bold', 'font-size': '16px'}).appendTo($tbody_tr_data_td);
...
//打开页时,在下拉列表中显示当前年月,并调用自定义函数drawCld(),显示公历和农历的相关信息
        function initial() {
            /*设置默认年份*/
            $thead_tr_td_select_Y.val(tY);
            /*设置默认月份*/
            $thead_tr_td_select_M.val(tM + 1);
